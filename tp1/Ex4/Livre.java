public class Livre {
  ...
  public int compare(Livre x) {
    if (x.getNbPages() == this.getNbPages()) {
      return 0;
    } else if (x.getNbPages() > this.getNbPages()) {
      return 1;
    } else {
      return -1;
    }
  ...
  public static int compare2(Livre x, Livre y) {
    if (x.getNbPages() == y.getNbPages()) {
      return 0;
    } else if (x.getNbPages() < y.getNbPages()) {
      return 1;
    } else {
      return -1;
    }
  ...
  public String toString() {
    if (this.prixFixe == false) {
      ...
      return (
        this.titre + "," + this.auteur + "," + this.nbPages + "," + this.prix
      );
    }
  }
}
